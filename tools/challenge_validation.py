...
def calculate_average_results(results_dict: dict, thresholds, output_file):
    ...
    avg = pd.DataFrame(columns=["TP", "FP", "FN", "TN", "RT"])
    for threshold in thresholds:
        # TP, FP, FN, TN, RT
        results = [0, 0, 0, 0, 0]
        for vid, res_dict in results_dict.items():
            results = [res + new for res, new in zip(results, res_dict[threshold])]
        avg.loc[-1] = results
        avg.index += 1
        avg.sort_index()
...
def main():
    folder_detection = "/home/yael/Downloads/challenge_CVC_2/challenge/Detection/CVC2/"
    folder_localization = "/home/yael/Downloads/challenge_CVC_2/challenge/Localization/CVC2/"
    folder_gt = "/home/yael/Downloads/PolypDetectionTest/GT"
    folder_output = "/home/yael/Downloads/challenge_CVC_2/challenge/results_python/CVC2/"
    ...
    for detection, localization in zip(files_detection, files_localization):
        ...
        localization_confidence = localization_df.shape[1] > 4

...
# AFFINE
_C.INPUT.PROB_AFFINE = 0.5
_C.INPUT.SHEAR = (2, 2)
_C.INPUT.ROTATION = (-5, 5)
_C.INPUT.TRANSLATION_FACTOR = (0.1, 0.1)
_C.INPUT.SCALE_FACTOR = (0.1, 0.1)
...
_C.MODEL.ROI_BOX_HEAD.CUSTOM_POSTPROCESS = False
_C.MODEL.ROI_BOX_HEAD.PREVIOUS_FRAMES = 0
_C.MODEL.ROI_BOX_HEAD.PROCESS_SATURATED = False
_C.MODEL.ROI_BOX_HEAD.PROCESS_COHERENCE = False
_C.MODEL.ROI_BOX_HEAD.PROCESS_DARK = False
...
_C.SOLVER.SCHEDULER = "multi_step"
_C.SOLVER.GAMMA = 0.1
